...
class VICCLR2S1PRDRA(nn.Module):
    def __init__(
      self,
      net1,
      net2,
    ...
    def forward(
        ...
        video_rand_average # video.shape = B, N, C, T-1, H, W
    ):
        ...
        assert (video_rand_derivative.shape == video_rand_average.shape), 'The shape of all input must be the same'
        ...
        hidden2 = flatten(self.encoder2(video_rand_average.view(B*N, C, T, H, W))) # encoder2 forward
