...
def main():
    ...
    ckpt_folder='/data/checkpoints_yehengz/swin_2s_rdra/%s%s_%s_%s/sym%s_bs%s_lr%s_wd%s_ds%s_sl%s_nw_rand%s_warmup%s_projection_size%s_tau%s_epoch_num%s_operation%s_prob_derivative%s_prob_average%s_seed%s' \
        % (dataname, args.fraction, ind_name, model_name, args.sym_loss, args.batch_size, args.base_lr, args.wd, args.downsample, args.seq_len, args.random, args.warm_up, args.projection, args.temperature, args.epochs, operation, args.prob_derivative, args.prob_average, args.seed)
...
# python evaluation/eval_retrieval.py --ckpt_folder /data/checkpoints_yehengz/swin_2s_rdra/ucf1.0_nce_swin3dtiny/symTrue_bs64_lr0.00056_wd1e-06_ds3_sl8_nw_randFalse_warmupTrue_projection_size2048_tau0.1_epoch_num400_operation_summation_prob_derivative0.25_prob_average0.75_seed3407 --epoch_num 400 --gpu '5' --swin --which_encoder 1
# python evaluation/eval_retrieval.py --ckpt_folder /data/checkpoints_yehengz/swin_2s_rdra/ucf1.0_nce_swin3dtiny/symTrue_bs64_lr0.00056_wd1e-06_ds3_sl8_nw_randFalse_warmupTrue_projection_size2048_tau0.1_epoch_num400_operation_summation_prob_derivative0.25_prob_average0.75_seed3407 --epoch_num 400 --gpu '6' --swin --which_encoder 2
