...
from vicclr2se1alternate import VICCLR2SE1AD
...
from dataloader import get_data_ucf, get_data_k400, get_data_mk200, get_data_mk400, get_data_minik, get_data_ucf_derivative
...
def train_one_epoch(args, model, train_loader, optimizer, epoch, gpu=None, scaler=None, train=True, diff=False, mix=False, mix2=False):
    ...
    for step, data in enumerate(train_loader, start=epoch * len(train_loader)):
        ...
        # N = 2 by default
        video, video_derivative, label = data # B, N, C, T, H, W
        label = label.to(gpu)
        video = video.to(gpu)
        video_derivative.to(gpu)
        ...
        with torch.cuda.amp.autocast():
            loss = model(video, video_derivative, epoch)
            if train:
...
def main():
    ...
    ckpt_folder='/data/checkpoints_yehengz/2streams_E1Alternative_derivative/%s%s_%s_%s/sym%s_bs%s_lr%s_wd%s_ds%s_sl%s_nw_rand%s_seed%s_operation%s' \
    ...
    if args.k400:
        ...
        loader_method = get_data_ucf_derivative
...
# torchrun --standalone --nnodes=1 --nproc_per_node=8 experiments/train_net3d_2s_f1_alternate.py --sym_loss --infonce --epochs 400 --seed 233
# torchrun --standalone --nnodes=1 --nproc_per_node=8 experiments/train_net3d_2s_f1_alternate.py --sym_loss --infonce --epochs 400 --seed 233 --concat
...
# torchrun --standalone --nnodes=1 --nproc_per_node=8 experiments/train_net3d_2s_f1_alternate.py --sym_loss --infonce --epochs 400 --seed 42 --concat    
...
# torchrun --standalone --nnodes=1 --nproc_per_node=8 experiments/train_net3d_2s_f1_alternate.py --sym_loss --infonce --epochs 400 --seed 3407 --concat   
    

# python evaluation/eval_retrieval.py --ckpt_folder /data/checkpoints_yehengz/2streams_E1Alternative_derivative/ucf_rd1.0_nce2s_r3d18/symTrue_bs64_lr4.8_wd1e-06_ds3_sl8_nw_randFalse_seed233_operation_summation --epoch_num 400
# python evaluation/eval_retrieval.py --ckpt_folder /data/checkpoints_yehengz/2streams_E1Alternative_derivative/ucf_rd1.0_nce2s_r3d18/symTrue_bs64_lr4.8_wd1e-06_ds3_sl8_nw_randFalse_seed233_operation_summation --epoch_num 400 --which_encoder 2
# python evaluation/eval_retrieval_2encoders.py --ckpt_folder /data/checkpoints_yehengz/2streams_E1Alternative_derivative/ucf_rd1.0_nce2s_r3d18/symTrue_bs64_lr4.8_wd1e-06_ds3_sl8_nw_randFalse_seed233_operation_summation --epoch_num 400
# python evaluation/eval_retrieval_2encoders.py --ckpt_folder /data/checkpoints_yehengz/2streams_E1Alternative_derivative/ucf_rd1.0_nce2s_r3d18/symTrue_bs64_lr4.8_wd1e-06_ds3_sl8_nw_randFalse_seed233_operation_summation --epoch_num 400 --concat
# python evaluation/image_retrieval.py --ckpt_folder /data/checkpoints_yehengz/2streams_E1Alternative_derivative/ucf_rd1.0_nce2s_r3d18/symTrue_bs64_lr4.8_wd1e-06_ds3_sl8_nw_randFalse_seed233_operation_summation --epoch_num 400 
# python evaluation/image_retrieval.py --ckpt_folder /data/checkpoints_yehengz/2streams_E1Alternative_derivative/ucf_rd1.0_nce2s_r3d18/symTrue_bs64_lr4.8_wd1e-06_ds3_sl8_nw_randFalse_seed233_operation_summation --epoch_num 400 --which_encoder 2
# python evaluation/image_retrieval_2encoders.py --ckpt_folder /data/checkpoints_yehengz/2streams_E1Alternative_derivative/ucf_rd1.0_nce2s_r3d18/symTrue_bs64_lr4.8_wd1e-06_ds3_sl8_nw_randFalse_seed233_operation_summation --epoch_num 400
# python evaluation/image_retrieval_2encoders.py --ckpt_folder /data/checkpoints_yehengz/2streams_E1Alternative_derivative/ucf_rd1.0_nce2s_r3d18/symTrue_bs64_lr4.8_wd1e-06_ds3_sl8_nw_randFalse_seed233_operation_summation --epoch_num 400 --concat

# python evaluation/eval_retrieval.py --ckpt_folder /data/checkpoints_yehengz/2streams_E1Alternative_derivative/ucf_rd1.0_nce2s_r3d18/symTrue_bs64_lr4.8_wd1e-06_ds3_sl8_nw_randFalse_seed233_operation_summation --epoch_num 300
# python evaluation/eval_retrieval.py --ckpt_folder /data/checkpoints_yehengz/2streams_E1Alternative_derivative/ucf_rd1.0_nce2s_r3d18/symTrue_bs64_lr4.8_wd1e-06_ds3_sl8_nw_randFalse_seed233_operation_summation --epoch_num 300 --which_encoder 2
# python evaluation/eval_retrieval.py --ckpt_folder /data/checkpoints_yehengz/2streams_E1Alternative_derivative/ucf_rd1.0_nce2s_r3d18/symTrue_bs64_lr4.8_wd1e-06_ds3_sl8_nw_randFalse_seed233_operation_summation --epoch_num 200
# python evaluation/eval_retrieval.py --ckpt_folder /data/checkpoints_yehengz/2streams_E1Alternative_derivative/ucf_rd1.0_nce2s_r3d18/symTrue_bs64_lr4.8_wd1e-06_ds3_sl8_nw_randFalse_seed233_operation_summation --epoch_num 200 --which_encoder 2
# python evaluation/eval_retrieval.py --ckpt_folder /data/checkpoints_yehengz/2streams_E1Alternative_derivative/ucf_rd1.0_nce2s_r3d18/symTrue_bs64_lr4.8_wd1e-06_ds3_sl8_nw_randFalse_seed233_operation_summation --epoch_num 100
# python evaluation/eval_retrieval.py --ckpt_folder /data/checkpoints_yehengz/2streams_E1Alternative_derivative/ucf_rd1.0_nce2s_r3d18/symTrue_bs64_lr4.8_wd1e-06_ds3_sl8_nw_randFalse_seed233_operation_summation --epoch_num 100 --which_encoder 2