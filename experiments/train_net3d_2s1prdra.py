...
def main():
    ...
    ckpt_folder='/data/checkpoints_yehengz/2streams1proj_rand_derivative_rand_average/%s%s_%s_%s/sym%s_bs%s_lr%s_wd%s_ds%s_sl%s_nw_rand%s_seed%s_operation%s_prob_derivative%s_prob_average%s' \
