...
def main():
    ...
    ckpt_folder='/data/checkpoints_yehengz/2s2p_base/%s%s_%s_%s/sym%s_bs%s_lr%s_wd%s_ds%s_sl%s_nw_rand%s_feature_size%s_projection%s_proj_hidden%s_epochs%s_seed%s_operation%s_width_deduc_ratio%s_stem_deduct%s' \
