...
def main():
    ...
    ckpt_folder='/data/checkpoints_yehengz/swin_ViDiDi_updated/%s%s_%s_%s/sym%s_bs%s_lr%s_wd%s_ds%s_sl%s_nw_rand%s_warmup%s_projection_size%s_tau%s_epoch_num%s' \
