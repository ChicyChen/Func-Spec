...
parser.add_argument('--concat', default='store_true') # default value is false, this arugment decide if we are summing two output from each encoders or concatenating them
